...
class ContextBuilder
{
    ...
    public function assemble(array $history, array $userInputMessage, array $workspaceStats = []): array
    {
        ...
        // Bound the conversation window sent to the model to the last 5 exchanges
        // (keeps prompt size small, avoids blowing provider token-per-minute limits).
