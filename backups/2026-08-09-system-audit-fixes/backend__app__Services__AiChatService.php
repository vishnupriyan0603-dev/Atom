...
class AiChatService
{
    ...
    public function process(int $chatId, string $message): array
    {
        ...
        $brain = $this->getAtomBrain();
        $responseContent = $brain->process($message, $history, $chat->provider, $chat->model);
